#include "stdafx.h"
#include "Effect_Splashcylinder3.h"
#include "GameInstance.h"

CEffect_Splashcylinder3::CEffect_Splashcylinder3(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_Splashcylinder3::CEffect_Splashcylinder3(const CEffect_Splashcylinder3& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_Splashcylinder3::NativeConstruct_Prototype()
{
...
HRESULT CEffect_Splashcylinder3::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_Splashcylinder3::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_Splashcylinder3::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_Splashcylinder3::Render()
{
	...
	XMStoreFloat4x4(&BillboardMatrix,
		...
		XMMatrixTranslation(-0.3f, 0.f, 0.74f)
		* WorldMatrix);
	...
	//m_EffectDesc.fAlpha += m_FlashTimeDelta * 1.f;
...
void CEffect_Splashcylinder3::Trigger_Activate(const _double& _fTimeDelta)
{
}

HRESULT CEffect_Splashcylinder3::SetUp_Components()
{
	return S_OK;
}

CEffect_Splashcylinder3* CEffect_Splashcylinder3::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_Splashcylinder3* pInstance = new CEffect_Splashcylinder3(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_Splashcylinder3");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_Splashcylinder3::Clone(void* pArg)
{
	CEffect_Splashcylinder3* pInstance = new CEffect_Splashcylinder3(*this);
...
void CEffect_Splashcylinder3::Free()
{
	__super::Free();
}
