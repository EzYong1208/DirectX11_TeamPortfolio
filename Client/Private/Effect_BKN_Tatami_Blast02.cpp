#include "stdafx.h"
#include "Effect_BKN_Tatami_Blast02.h"
#include "GameInstance.h"

CEffect_BKN_Tatami_Blast02::CEffect_BKN_Tatami_Blast02(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_BKN_Tatami_Blast02::CEffect_BKN_Tatami_Blast02(const CEffect_BKN_Tatami_Blast02& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_BKN_Tatami_Blast02::NativeConstruct_Prototype()
{
...
HRESULT CEffect_BKN_Tatami_Blast02::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_BKN_Tatami_Blast02::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_BKN_Tatami_Blast02::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_BKN_Tatami_Blast02::Render()
{
	...
	XMStoreFloat4x4(&BillboardMatrix,
		...
		XMMatrixTranslation(0.75f, 0.1f, 0.f)
		* WorldMatrix);
...
CEffect_BKN_Tatami_Blast02* CEffect_BKN_Tatami_Blast02::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_BKN_Tatami_Blast02* pInstance = new CEffect_BKN_Tatami_Blast02(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_BKN_Tatami_Blast02");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_BKN_Tatami_Blast02::Clone(void* pArg)
{
	CEffect_BKN_Tatami_Blast02* pInstance = new CEffect_BKN_Tatami_Blast02(*this);
...
void CEffect_BKN_Tatami_Blast02::Free()
{
	__super::Free();
}
