#include "stdafx.h"
#include "Effect_MAY_Anchor_Upper.h"
#include "GameInstance.h"

CEffect_MAY_Anchor_Upper::CEffect_MAY_Anchor_Upper(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_MAY_Anchor_Upper::CEffect_MAY_Anchor_Upper(const CEffect_MAY_Anchor_Upper& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_MAY_Anchor_Upper::NativeConstruct_Prototype()
{
...
HRESULT CEffect_MAY_Anchor_Upper::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_MAY_Anchor_Upper::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_MAY_Anchor_Upper::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_MAY_Anchor_Upper::Render()
{
...
void CEffect_MAY_Anchor_Upper::Trigger_Activate(const _double& _fTimeDelta)
{
	
}

HRESULT CEffect_MAY_Anchor_Upper::SetUp_Components()
{
	return S_OK;
}

CEffect_MAY_Anchor_Upper* CEffect_MAY_Anchor_Upper::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_MAY_Anchor_Upper* pInstance = new CEffect_MAY_Anchor_Upper(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_MAY_Anchor_Upper");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_MAY_Anchor_Upper::Clone(void* pArg)
{
	CEffect_MAY_Anchor_Upper* pInstance = new CEffect_MAY_Anchor_Upper(*this);
...
void CEffect_MAY_Anchor_Upper::Free()
{
	__super::Free();
}
