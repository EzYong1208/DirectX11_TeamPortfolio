#include "stdafx.h"
#include "Effect_JKO_5D_Windring.h"
#include "GameInstance.h"

CEffect_JKO_5D_Windring::CEffect_JKO_5D_Windring(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_JKO_5D_Windring::CEffect_JKO_5D_Windring(const CEffect_JKO_5D_Windring& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_JKO_5D_Windring::NativeConstruct_Prototype()
{
...
HRESULT CEffect_JKO_5D_Windring::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_JKO_5D_Windring::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_JKO_5D_Windring::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_JKO_5D_Windring::Render()
{
...
CEffect_JKO_5D_Windring* CEffect_JKO_5D_Windring::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_JKO_5D_Windring* pInstance = new CEffect_JKO_5D_Windring(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_JKO_5D_Windring");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_JKO_5D_Windring::Clone(void* pArg)
{
	CEffect_JKO_5D_Windring* pInstance = new CEffect_JKO_5D_Windring(*this);
...
void CEffect_JKO_5D_Windring::Free()
{
	__super::Free();
}
