#include "stdafx.h"
#include "Effect_Splashcylinder1.h"
#include "GameInstance.h"

CEffect_Splashcylinder1::CEffect_Splashcylinder1(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_Splashcylinder1::CEffect_Splashcylinder1(const CEffect_Splashcylinder1& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_Splashcylinder1::NativeConstruct_Prototype()
{
...
HRESULT CEffect_Splashcylinder1::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_Splashcylinder1::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_Splashcylinder1::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_Splashcylinder1::Render()
{
	...
	XMStoreFloat4x4(&BillboardMatrix,
		...
		XMMatrixTranslation(0.f, -0.3f, -0.1f)
		* WorldMatrix);
...
void CEffect_Splashcylinder1::Trigger_Activate(const _double& _fTimeDelta)
{
}

HRESULT CEffect_Splashcylinder1::SetUp_Components()
{
	return S_OK;
}

CEffect_Splashcylinder1* CEffect_Splashcylinder1::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_Splashcylinder1* pInstance = new CEffect_Splashcylinder1(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_Splashcylinder1");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_Splashcylinder1::Clone(void* pArg)
{
	CEffect_Splashcylinder1* pInstance = new CEffect_Splashcylinder1(*this);
...
void CEffect_Splashcylinder1::Free()
{
	__super::Free();
}
