#include "stdafx.h"
#include "Effect_JKO_5D_Wind.h"
#include "GameInstance.h"

CEffect_JKO_5D_Wind::CEffect_JKO_5D_Wind(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_JKO_5D_Wind::CEffect_JKO_5D_Wind(const CEffect_JKO_5D_Wind& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_JKO_5D_Wind::NativeConstruct_Prototype()
{
...
HRESULT CEffect_JKO_5D_Wind::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_JKO_5D_Wind::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_JKO_5D_Wind::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_JKO_5D_Wind::Render()
{
...
CEffect_JKO_5D_Wind* CEffect_JKO_5D_Wind::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_JKO_5D_Wind* pInstance = new CEffect_JKO_5D_Wind(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_JKO_5D_Wind");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_JKO_5D_Wind::Clone(void* pArg)
{
	CEffect_JKO_5D_Wind* pInstance = new CEffect_JKO_5D_Wind(*this);
