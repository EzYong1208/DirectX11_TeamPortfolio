#include "stdafx.h"
#include "Effect_GOS_Splash01.h"
#include "GameInstance.h"

CEffect_GOS_Splash01::CEffect_GOS_Splash01(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_BillboardValueFix_Effect(pDevice, pDeviceContext)
{
}

CEffect_GOS_Splash01::CEffect_GOS_Splash01(const CEffect_GOS_Splash01& rhs)
	: CEffect_BillboardValueFix_Effect(rhs)
{
}

HRESULT CEffect_GOS_Splash01::NativeConstruct_Prototype()
{
...
HRESULT CEffect_GOS_Splash01::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_GOS_Splash01::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_GOS_Splash01::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_GOS_Splash01::Render()
{
...
CEffect_GOS_Splash01* CEffect_GOS_Splash01::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_GOS_Splash01* pInstance = new CEffect_GOS_Splash01(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_GOS_Splash01");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_GOS_Splash01::Clone(void* pArg)
{
	CEffect_GOS_Splash01* pInstance = new CEffect_GOS_Splash01(*this);
...
void CEffect_GOS_Splash01::Free()
{
	__super::Free();
}
