#include "stdafx.h"
#include "Effect_MAY_SlashSpark01.h"
#include "GameInstance.h"

CEffect_MAY_SlashSpark01::CEffect_MAY_SlashSpark01(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_BillboardValueFix_Effect(pDevice, pDeviceContext)
{
}

CEffect_MAY_SlashSpark01::CEffect_MAY_SlashSpark01(const CEffect_MAY_SlashSpark01& rhs)
	: CEffect_BillboardValueFix_Effect(rhs)
{
}

HRESULT CEffect_MAY_SlashSpark01::NativeConstruct_Prototype()
{
...
HRESULT CEffect_MAY_SlashSpark01::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_MAY_SlashSpark01::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_MAY_SlashSpark01::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_MAY_SlashSpark01::Render()
{
...
CEffect_MAY_SlashSpark01* CEffect_MAY_SlashSpark01::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_MAY_SlashSpark01* pInstance = new CEffect_MAY_SlashSpark01(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_MAY_SlashSpark01");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_MAY_SlashSpark01::Clone(void* pArg)
{
	CEffect_MAY_SlashSpark01* pInstance = new CEffect_MAY_SlashSpark01(*this);
...
void CEffect_MAY_SlashSpark01::Free()
{
	__super::Free();
}
