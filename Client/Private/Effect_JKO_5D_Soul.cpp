#include "stdafx.h"
#include "Effect_JKO_5D_Soul.h"
#include "GameInstance.h"

CEffect_JKO_5D_Soul::CEffect_JKO_5D_Soul(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_JKO_5D_Soul::CEffect_JKO_5D_Soul(const CEffect_JKO_5D_Soul& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_JKO_5D_Soul::NativeConstruct_Prototype()
{
...
HRESULT CEffect_JKO_5D_Soul::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_JKO_5D_Soul::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_JKO_5D_Soul::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_JKO_5D_Soul::Render()
{
...
CEffect_JKO_5D_Soul* CEffect_JKO_5D_Soul::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_JKO_5D_Soul* pInstance = new CEffect_JKO_5D_Soul(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_JKO_5D_Soul");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_JKO_5D_Soul::Clone(void* pArg)
{
	CEffect_JKO_5D_Soul* pInstance = new CEffect_JKO_5D_Soul(*this);
