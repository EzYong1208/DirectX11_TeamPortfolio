#include "stdafx.h"
#include "Effect_BKN_Tatami_Line.h"
#include "GameInstance.h"

CEffect_BKN_Tatami_Line::CEffect_BKN_Tatami_Line(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_BKN_Tatami_Line::CEffect_BKN_Tatami_Line(const CEffect_BKN_Tatami_Line& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_BKN_Tatami_Line::NativeConstruct_Prototype()
{
...
HRESULT CEffect_BKN_Tatami_Line::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_BKN_Tatami_Line::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_BKN_Tatami_Line::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_BKN_Tatami_Line::Render()
{
	...
	XMStoreFloat4x4(&BillboardMatrix,
		...
		XMMatrixTranslation(0.2f, 0.f, 0.f)
		* WorldMatrix);
...
CEffect_BKN_Tatami_Line* CEffect_BKN_Tatami_Line::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_BKN_Tatami_Line* pInstance = new CEffect_BKN_Tatami_Line(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_BKN_Tatami_Line");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_BKN_Tatami_Line::Clone(void* pArg)
{
	CEffect_BKN_Tatami_Line* pInstance = new CEffect_BKN_Tatami_Line(*this);
...
void CEffect_BKN_Tatami_Line::Free()
{
	__super::Free();
}
