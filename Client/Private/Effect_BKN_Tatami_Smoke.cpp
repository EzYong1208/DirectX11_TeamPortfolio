#include "stdafx.h"
#include "Effect_BKN_Tatami_Smoke.h"
#include "GameInstance.h"

CEffect_BKN_Tatami_Smoke::CEffect_BKN_Tatami_Smoke(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_BKN_Tatami_Smoke::CEffect_BKN_Tatami_Smoke(const CEffect_BKN_Tatami_Smoke& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_BKN_Tatami_Smoke::NativeConstruct_Prototype()
{
...
HRESULT CEffect_BKN_Tatami_Smoke::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_BKN_Tatami_Smoke::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_BKN_Tatami_Smoke::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_BKN_Tatami_Smoke::Render()
{
...
CEffect_BKN_Tatami_Smoke* CEffect_BKN_Tatami_Smoke::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_BKN_Tatami_Smoke* pInstance = new CEffect_BKN_Tatami_Smoke(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_BKN_Tatami_Smoke");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_BKN_Tatami_Smoke::Clone(void* pArg)
{
	CEffect_BKN_Tatami_Smoke* pInstance = new CEffect_BKN_Tatami_Smoke(*this);
...
void CEffect_BKN_Tatami_Smoke::Free()
{
	__super::Free();
}
