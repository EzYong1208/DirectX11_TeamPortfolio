#include "stdafx.h"
#include "Effect_JKO_5K.h"
#include "GameInstance.h"

CEffect_JKO_5K::CEffect_JKO_5K(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_JKO_5K::CEffect_JKO_5K(const CEffect_JKO_5K& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_JKO_5K::NativeConstruct_Prototype()
{
...
HRESULT CEffect_JKO_5K::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_JKO_5K::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_JKO_5K::LateTick(_double TimeDelta)
{
...
void CEffect_JKO_5K::SetMaterialIndex()
{
...
CEffect_JKO_5K* CEffect_JKO_5K::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_JKO_5K* pInstance = new CEffect_JKO_5K(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_JKO_5K");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_JKO_5K::Clone(void* pArg)
{
	CEffect_JKO_5K* pInstance = new CEffect_JKO_5K(*this);
