#include "stdafx.h"
#include "Effect_BKN_2H02.h"
#include "GameInstance.h"

CEffect_BKN_2H02::CEffect_BKN_2H02(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_BKN_2H02::CEffect_BKN_2H02(const CEffect_BKN_2H02& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_BKN_2H02::NativeConstruct_Prototype()
{
...
HRESULT CEffect_BKN_2H02::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_BKN_2H02::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_BKN_2H02::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_BKN_2H02::Render()
{
	...
	XMStoreFloat4x4(&BillboardMatrix,
		...
		XMMatrixTranslation(-0.1f, 0.f, 0.f)
		* WorldMatrix);
...
CEffect_BKN_2H02* CEffect_BKN_2H02::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_BKN_2H02* pInstance = new CEffect_BKN_2H02(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_BKN_2H02");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_BKN_2H02::Clone(void* pArg)
{
	CEffect_BKN_2H02* pInstance = new CEffect_BKN_2H02(*this);
