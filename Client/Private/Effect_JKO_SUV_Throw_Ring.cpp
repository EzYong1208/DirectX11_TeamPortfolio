#include "stdafx.h"
#include "Effect_JKO_SUV_Throw_Ring.h"
#include "GameInstance.h"

CEffect_JKO_SUV_Throw_Ring::CEffect_JKO_SUV_Throw_Ring(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_JKO_SUV_Throw_Ring::CEffect_JKO_SUV_Throw_Ring(const CEffect_JKO_SUV_Throw_Ring& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_JKO_SUV_Throw_Ring::NativeConstruct_Prototype()
{
...
HRESULT CEffect_JKO_SUV_Throw_Ring::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_JKO_SUV_Throw_Ring::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_JKO_SUV_Throw_Ring::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_JKO_SUV_Throw_Ring::Render()
{
...
CEffect_JKO_SUV_Throw_Ring* CEffect_JKO_SUV_Throw_Ring::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_JKO_SUV_Throw_Ring* pInstance = new CEffect_JKO_SUV_Throw_Ring(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_JKO_SUV_Throw_Ring");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_JKO_SUV_Throw_Ring::Clone(void* pArg)
{
	CEffect_JKO_SUV_Throw_Ring* pInstance = new CEffect_JKO_SUV_Throw_Ring(*this);
...
void CEffect_JKO_SUV_Throw_Ring::Free()
{
	__super::Free();
}
