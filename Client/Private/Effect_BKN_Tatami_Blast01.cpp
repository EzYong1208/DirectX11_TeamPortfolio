#include "stdafx.h"
#include "Effect_BKN_Tatami_Blast01.h"
#include "GameInstance.h"

CEffect_BKN_Tatami_Blast01::CEffect_BKN_Tatami_Blast01(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_BKN_Tatami_Blast01::CEffect_BKN_Tatami_Blast01(const CEffect_BKN_Tatami_Blast01& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_BKN_Tatami_Blast01::NativeConstruct_Prototype()
{
...
HRESULT CEffect_BKN_Tatami_Blast01::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_BKN_Tatami_Blast01::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_BKN_Tatami_Blast01::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_BKN_Tatami_Blast01::Render()
{
...
CEffect_BKN_Tatami_Blast01* CEffect_BKN_Tatami_Blast01::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_BKN_Tatami_Blast01* pInstance = new CEffect_BKN_Tatami_Blast01(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_BKN_Tatami_Blast01");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_BKN_Tatami_Blast01::Clone(void* pArg)
{
	CEffect_BKN_Tatami_Blast01* pInstance = new CEffect_BKN_Tatami_Blast01(*this);
...
void CEffect_BKN_Tatami_Blast01::Free()
{
	__super::Free();
}
