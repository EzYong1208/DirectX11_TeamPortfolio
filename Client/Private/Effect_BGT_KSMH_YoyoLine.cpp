#include "stdafx.h"
#include "Effect_BGT_KSMH_YoyoLine.h"
#include "GameInstance.h"

CEffect_BGT_KSMH_YoyoLine::CEffect_BGT_KSMH_YoyoLine(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_BillboardValueFix_Effect(pDevice, pDeviceContext)
{
}

CEffect_BGT_KSMH_YoyoLine::CEffect_BGT_KSMH_YoyoLine(const CEffect_BGT_KSMH_YoyoLine& rhs)
	: CEffect_BillboardValueFix_Effect(rhs)
{
}

HRESULT CEffect_BGT_KSMH_YoyoLine::NativeConstruct_Prototype()
{
...
HRESULT CEffect_BGT_KSMH_YoyoLine::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_BGT_KSMH_YoyoLine::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_BGT_KSMH_YoyoLine::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_BGT_KSMH_YoyoLine::Render()
{
...
_uint CEffect_BGT_KSMH_YoyoLine::SetMaterialIndex()
{
...
CEffect_BGT_KSMH_YoyoLine* CEffect_BGT_KSMH_YoyoLine::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_BGT_KSMH_YoyoLine* pInstance = new CEffect_BGT_KSMH_YoyoLine(pDevice, pDeviceContext);
...
CGameObject* CEffect_BGT_KSMH_YoyoLine::Clone(void* pArg)
{
	CEffect_BGT_KSMH_YoyoLine* pInstance = new CEffect_BGT_KSMH_YoyoLine(*this);
...
void CEffect_BGT_KSMH_YoyoLine::Free()
{
	__super::Free();
}
