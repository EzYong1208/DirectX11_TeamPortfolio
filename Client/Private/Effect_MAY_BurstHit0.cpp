#include "stdafx.h"
#include "Effect_MAY_BurstHit0.h"
#include "GameInstance.h"

CEffect_MAY_BurstHit0::CEffect_MAY_BurstHit0(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_BillboardValueFix_Effect(pDevice, pDeviceContext)
{
}

CEffect_MAY_BurstHit0::CEffect_MAY_BurstHit0(const CEffect_MAY_BurstHit0& rhs)
	: CEffect_BillboardValueFix_Effect(rhs)
{
}

HRESULT CEffect_MAY_BurstHit0::NativeConstruct_Prototype()
{
...
HRESULT CEffect_MAY_BurstHit0::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_MAY_BurstHit0::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_MAY_BurstHit0::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_MAY_BurstHit0::Render()
{
...
CEffect_MAY_BurstHit0* CEffect_MAY_BurstHit0::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_MAY_BurstHit0* pInstance = new CEffect_MAY_BurstHit0(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_MAY_BurstHit0");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_MAY_BurstHit0::Clone(void* pArg)
{
	CEffect_MAY_BurstHit0* pInstance = new CEffect_MAY_BurstHit0(*this);
...
void CEffect_MAY_BurstHit0::Free()
{
	__super::Free();
}
