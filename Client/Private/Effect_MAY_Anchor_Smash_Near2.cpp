#include "stdafx.h"
#include "Effect_MAY_Anchor_Smash_Near2.h"
#include "GameInstance.h"

CEffect_MAY_Anchor_Smash_Near2::CEffect_MAY_Anchor_Smash_Near2(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_None_Anim_Effect(pDevice, pDeviceContext)
{
}

CEffect_MAY_Anchor_Smash_Near2::CEffect_MAY_Anchor_Smash_Near2(const CEffect_MAY_Anchor_Smash_Near2& rhs)
	: CEffect_None_Anim_Effect(rhs)
{
}

HRESULT CEffect_MAY_Anchor_Smash_Near2::NativeConstruct_Prototype()
{
...
HRESULT CEffect_MAY_Anchor_Smash_Near2::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_MAY_Anchor_Smash_Near2::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_MAY_Anchor_Smash_Near2::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_MAY_Anchor_Smash_Near2::Render()
{
...
void CEffect_MAY_Anchor_Smash_Near2::Trigger_Activate(const _double& _fTimeDelta)
{
}

HRESULT CEffect_MAY_Anchor_Smash_Near2::SetUp_Components()
{
	return S_OK;
}

CEffect_MAY_Anchor_Smash_Near2* CEffect_MAY_Anchor_Smash_Near2::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_MAY_Anchor_Smash_Near2* pInstance = new CEffect_MAY_Anchor_Smash_Near2(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_MAY_Anchor_Smash_Near2");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_MAY_Anchor_Smash_Near2::Clone(void* pArg)
{
	CEffect_MAY_Anchor_Smash_Near2* pInstance = new CEffect_MAY_Anchor_Smash_Near2(*this);
...
void CEffect_MAY_Anchor_Smash_Near2::Free()
{
	__super::Free();
}
