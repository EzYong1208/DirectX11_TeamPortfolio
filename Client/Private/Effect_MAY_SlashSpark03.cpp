#include "stdafx.h"
#include "Effect_MAY_SlashSpark03.h"
#include "GameInstance.h"

CEffect_MAY_SlashSpark03::CEffect_MAY_SlashSpark03(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_BillboardValueFix_Effect(pDevice, pDeviceContext)
{
}

CEffect_MAY_SlashSpark03::CEffect_MAY_SlashSpark03(const CEffect_MAY_SlashSpark03& rhs)
	: CEffect_BillboardValueFix_Effect(rhs)
{
}

HRESULT CEffect_MAY_SlashSpark03::NativeConstruct_Prototype()
{
...
HRESULT CEffect_MAY_SlashSpark03::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_MAY_SlashSpark03::Tick(_double TimeDelta)
{
...
_int CEffect_MAY_SlashSpark03::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_MAY_SlashSpark03::Render()
{
...
CEffect_MAY_SlashSpark03* CEffect_MAY_SlashSpark03::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_MAY_SlashSpark03* pInstance = new CEffect_MAY_SlashSpark03(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_MAY_SlashSpark03");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_MAY_SlashSpark03::Clone(void* pArg)
{
	CEffect_MAY_SlashSpark03* pInstance = new CEffect_MAY_SlashSpark03(*this);
...
void CEffect_MAY_SlashSpark03::Free()
{
	__super::Free();
}
