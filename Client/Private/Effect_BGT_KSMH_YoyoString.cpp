#include "stdafx.h"
#include "Effect_BGT_KSMH_YoyoString.h"
#include "GameInstance.h"

CEffect_BGT_KSMH_YoyoString::CEffect_BGT_KSMH_YoyoString(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
	: CEffect_BillboardValueFix_Effect(pDevice, pDeviceContext)
{
}

CEffect_BGT_KSMH_YoyoString::CEffect_BGT_KSMH_YoyoString(const CEffect_BGT_KSMH_YoyoString& rhs)
	: CEffect_BillboardValueFix_Effect(rhs)
{
}

HRESULT CEffect_BGT_KSMH_YoyoString::NativeConstruct_Prototype()
{
...
HRESULT CEffect_BGT_KSMH_YoyoString::NativeConstruct(void* pArg)
{
	//	트랜스폼, 모델, 셰이더, 랜더러 추가
...
_int CEffect_BGT_KSMH_YoyoString::Tick(_double TimeDelta)
{
	int temp = 0;
...
_int CEffect_BGT_KSMH_YoyoString::LateTick(_double TimeDelta)
{
...
HRESULT CEffect_BGT_KSMH_YoyoString::Render()
{
...
_uint CEffect_BGT_KSMH_YoyoString::SetMaterialIndex()
{
...
CEffect_BGT_KSMH_YoyoString* CEffect_BGT_KSMH_YoyoString::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	CEffect_BGT_KSMH_YoyoString* pInstance = new CEffect_BGT_KSMH_YoyoString(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Created CEffect_BGT_KSMH_YoyoString");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CEffect_BGT_KSMH_YoyoString::Clone(void* pArg)
{
	CEffect_BGT_KSMH_YoyoString* pInstance = new CEffect_BGT_KSMH_YoyoString(*this);
...
void CEffect_BGT_KSMH_YoyoString::Free()
{
	__super::Free();
}
